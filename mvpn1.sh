...
echo ""
echo "Добро пожаловать в установку сервера для Офиссов от Boss-Kokos!"
echo ""
...
echo ""
echo "[*] Установка Завершена, интернет у тебя бдует нормальный и тебе не кто не набьет ебало!"
echo ""
echo "Ты можешь перейти в ЛК для установки конфига VPN"
