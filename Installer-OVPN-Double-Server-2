...
echo ""
read -p "Введите IP-адрес Сервера 1: " IPSERVER1

echo "Введите пароль от Сервера 1"
...
echo "На Сервере 1 /root/MineDoubleVPN.ovpn"
echo "Это мульти-конфиг, двойной OpenVpn"
echo ""
echo "=========================================="
echo ""
echo ""
